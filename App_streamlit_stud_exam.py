...
with open("studen_exam_visualisation/model_RF.pkl", "rb") as f:
    model = pickle.load(f)
...
if st.button("Visualisation"):
    ...
    st.image("studen_exam_visualisation/graph_corr.png", use_column_width=True)

    st.subheader(" Distribution des Matières")
    st.image("studen_exam_visualisation/histogram.png", use_column_width=True)

    st.subheader(" Boxplot des Notes")
    st.image("studen_exam_visualisation/boxplot.png", use_column_width=True)

    st.subheader(" Distribution_Total_Resultat")
    st.image("studen_exam_visualisation/Distribution_Total_Resultat.png", use_column_width=True)